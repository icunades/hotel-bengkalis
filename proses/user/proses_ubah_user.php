...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($ubah_password) {
        ...
        $query = "UPDATE tb_user SET username = '$username', email = '$email', no_hp = '$no_hp', password = '$password' WHERE id='$id'";
    } else {
        $query = "UPDATE tb_user SET username = '$username', email = '$email', no_hp = '$no_hp' WHERE id='$id'";
    }
